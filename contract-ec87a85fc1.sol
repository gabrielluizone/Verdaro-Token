...
contract Verdaro is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Verdaro", "DRO") ERC20Permit("Verdaro") {
        _mint(msg.sender, 20200 * 10 ** decimals());
    }
